...
mongoose.connect('mongodb+srv://aravinth-in:<db_password>@cluster0.6dmr7l7.mongodb.net/mongodb-basics')
.then(() => console.log('Database is connected successfully')).catch(e => console.log(e));
